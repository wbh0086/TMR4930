...
int main()
{
    src = imread( "/Users/Salmon/Desktop/MasterThesis/Materials/sc_web/tim3_thr_openingoprt.jpg" ,CV_LOAD_IMAGE_COLOR );     //注意路径得换成自己的
    cvtColor( src, src_gray, CV_BGR2GRAY );//灰度化
    GaussianBlur( src, src, Size(3,3), 0.1, 0, BORDER_DEFAULT );
    blur( src_gray, src_gray, Size(5,5) ); //滤波
